...
public class jbStealthNetServer {
	...
	public static PublicKey getPublicKey() {
		try {
			byte[] encodedServerKey = jbStealthNetStorage.retrieve(
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			jbStealthNetStorage.store("server_public", "".toCharArray(),
					encodedKey);

			encodedKey = dsaPublicKey.getEncoded();
			jbStealthNetStorage.store("server_dsa_public", "".toCharArray(),
					encodedKey);
