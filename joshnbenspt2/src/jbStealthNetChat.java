...
public class jbStealthNetChat extends Thread {
	...
	public jbStealthNetChat(String id, jbStealthNetComms snComms) {
		userID = id;
	...
	public Component createGUI() {
		...
		chatScrollPane.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createCompoundBorder(BorderFactory
						.createTitledBorder("Chat"), BorderFactory
						.createEmptyBorder(0, 0, 0, 0)), chatScrollPane
						.getBorder()));
	...
	private synchronized void sendChat() {
		...
		if (stealthComms != null)
			stealthComms.sendPacket(jbStealthNetPacket.CMD_MSG, msg);
		msgText.setText("");
	}
